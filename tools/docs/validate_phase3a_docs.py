#!/usr/bin/env python3
"""
Deterministic validation of Phase 3A doc integration.
...
MANUAL_TITLE = "Phase 3A — Pressure Eligibility and Diffusion (Design Freeze)"
RULEBOOK_SUBSECTION = "Phase 3A — Pressure eligibility and diffusion"
