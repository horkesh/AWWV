/**
 * Invoke Phase 3C docx edit script (python-docx) and then run validator.
...
const editScript = resolve(ROOT, 'tools/docs/edit_phase3c_spec.py');
const validateScript = resolve(ROOT, 'tools/docs/validate_phase3c_docs.py');
